...
/*!
 ...
 @param show Boolean to show or not show the ad.
 
 @discussion This is used by AIR as the response for shouldShow calls.
 */
+ (void)airShowInterstitial:(NSString*)location show:(BOOL)show;

/*!
 @abstract
 Present more apps for the given CBLocation.
...
/*! The cache for interstitials. */
@property (atomic, strong) NSMutableDictionary *airCachedInterstitials;

/*! The cache for rewarded video. */
@property (atomic, strong) NSMutableDictionary *airCachedRewardedVideos;
